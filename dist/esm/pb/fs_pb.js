...
// @generated message type with reflection information, may provide speed optimized methods
class GetUnaryRequest$Type extends MessageType {
    constructor() {
        super("pb.GetUnaryRequest", [
            ...
            { no: 3, name: "to_version", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 4, name: "queries", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => ObjectQuery },
            { no: 5, name: "max_content_send_size", kind: "scalar", opt: true, T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value) {
        const message = globalThis.Object.create((this.messagePrototype));
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated pb.ObjectQuery queries */ 4:
                    message.queries.push(ObjectQuery.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                case /* optional int64 max_content_send_size */ 5:
                    message.maxContentSendSize = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.maxContentSendSize !== undefined)
            writer.tag(5, WireType.Varint).int64(message.maxContentSendSize);
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
// @generated message type with reflection information, may provide speed optimized methods
class GetUnaryResponse$Type extends MessageType {
    constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetCacheResponse$Type extends MessageType {
    constructor() {
