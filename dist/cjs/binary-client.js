...
class DateiLagerBinaryClient {
    ...
    async gcRandomProjects(sample, keep, from, options) {
        return await (0, telemetry_1.trace)("dateilager-binary-client.gc-random-projects", {
            attributes: {
                "dl.keep": String(keep),
                "dl.from": String(from),
    ...
    async gcProject(project, keep, from, options) {
        return await (0, telemetry_1.trace)("dateilager-binary-client.gc-project", {
            attributes: {
                "dl.keep": String(keep),
                "dl.from": String(from),
            },
    ...
    async gcContents(sample, options) {
        return await (0, telemetry_1.trace)("dateilager-binary-client.gc-contents", {
            attributes: {
                "dl.sample": String(sample),
            },
        }, async () => {
